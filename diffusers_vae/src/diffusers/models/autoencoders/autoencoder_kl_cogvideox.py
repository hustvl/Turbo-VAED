    ...
    def forward(
        ...
        if torch.is_grad_enabled() and self.gradient_checkpointing:
            ...
            for i, up_block in enumerate(self.up_blocks):
                ...
                if feature_enabled:
                    feature_backup[f"up_block_{i}"] = hidden_states
        ...
        if feature_enabled:
            return hidden_states, new_conv_cache, feature_backup
...
class AutoencoderKLCogVideoX(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        self.num_latent_frames_batch_size = 8
    ...
    def _decode(self, z: torch.Tensor, return_dict: bool = True, feature_enabled: bool = False) -> Union[DecoderOutput, torch.Tensor]:
        ...
        for i in range(num_batches):
            ...
            if feature_enabled:
                z_intermediate, conv_cache, feature = self.decoder(z_intermediate, conv_cache=conv_cache, feature_enabled=feature_enabled)
            else:
    ...
    @apply_forward_hook
    def decode(self, z: torch.Tensor, return_dict: bool = True, feature_enabled: bool = False) -> Union[DecoderOutput, torch.Tensor]:
        """
        ...
        if self.use_slicing and z.shape[0] > 1:
            ...
            if feature_enabled:
                decoded, feature = self._decode(z, feature_enabled=feature_enabled)
